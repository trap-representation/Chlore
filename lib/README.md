...
The header files and the source of the object files in the standard library here are put here just to demonstrate how those are created, and implementations may define their own headers.

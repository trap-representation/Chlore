...
For NAOs (Non-Addressable objects) that are being dynamically loaded, if an environment doesn't support dynamically NAOS, it will produce a *force_panic* with/without any extra diagonistic message.
